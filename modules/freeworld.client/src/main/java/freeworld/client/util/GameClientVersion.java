 ...
 * @since 0.1.0
 */
public record GameClientVersion(String version) {
    private static final Gson GSON = new Gson();
    private static final GameClientVersion INSTANCE = load();

    public static GameClientVersion get() {
        return INSTANCE;
    }
    ...
    public static GameClientVersion load() {
        ...
        return GSON.fromJson(lines, GameClientVersion.class);
    }
}
